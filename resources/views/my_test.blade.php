...
<head>
    ...
    <title> Farmers Connect: Dashboard</title>
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="/theme/css/font-awesome.min.css">

    <!-- SmartAdmin Styles : Caution! DO NOT change the order -->
    <link rel="stylesheet" type="text/css" media="screen" href="/theme/css/smartadmin-production-plugins.min.css">
    ...
    <link rel="stylesheet" type="text/css" media="screen" href="/theme/css/smartadmin-rtl.min.css">
        ...
        <link rel="apple-touch-icon" href="/theme/img/splash/sptouch-icon-iphone.png">
        <link rel="apple-touch-icon" sizes="76x76" href="/theme/img/splash/touch-icon-ipad.png">
        <link rel="apple-touch-icon" sizes="120x120" href="/theme/img/splash/touch-icon-iphone-retina.png">
        <link rel="apple-touch-icon" sizes="152x152" href="/theme/img/splash/touch-icon-ipad-retina.png">
        ...
        <header id="header">
                ...
                <div class="ajax-dropdown">
                    ...
                    <div class="btn-group btn-group-justified" data-toggle="buttons">
                        ...
                        <ul class="header-dropdown-list hidden-xs">
                            <li>
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="/theme/img/blank.gif" class="flag flag-us" alt="United States"> <span> English (US) </span> <i class="fa fa-angle-down"></i> </a>
                                <ul class="dropdown-menu pull-right">
                                    <li class="active">
                                        <a href="javascript:void(0);"><img src="/theme/img/blank.gif" class="flag flag-us" alt="United States"> English (US)</a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);"><img src="/theme/img/blank.gif" class="flag flag-fr" alt="France"> Français</a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);"><img src="/theme/img/blank.gif" class="flag flag-es" alt="Spanish"> Español</a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);"><img src="/theme/img/blank.gif" class="flag flag-de" alt="German"> Deutsch</a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);"><img src="/theme/img/blank.gif" class="flag flag-jp" alt="Japan"> 日本語</a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);"><img src="/theme/img/blank.gif" class="flag flag-cn" alt="China"> 中文</a>
                                    </li>   
                                    <li>
                                        <a href="javascript:void(0);"><img src="/theme/img/blank.gif" class="flag flag-it" alt="Italy"> Italiano</a>
                                    </li>   
                                    <li>
                                        <a href="javascript:void(0);"><img src="/theme/img/blank.gif" class="flag flag-pt" alt="Portugal"> Portugal</a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);"><img src="/theme/img/blank.gif" class="flag flag-ru" alt="Russia"> Русский язык</a>
                                    </li>
                                    <li>
                                        <a href="javascript:void(0);"><img src="/theme/img/blank.gif" class="flag flag-kr" alt="Korea"> 한국어</a>
                                    </li>                       
            ...
            <ul>
                ...
                <li class="chat-users top-menu-invisible">
                    ...
                    <ul>
                        <li>
                            ...
                            <div class="display-users">
                                ...
                                data-content="
                                <div class='usr-card'>
                                    <img src='/theme/img/avatars/5.png' alt='Sadi Orlaf'>
                            ...
                            data-content="
                            <div class='usr-card'>
                                <img src='/theme/img/avatars/1.png' alt='Jessica Dolof'>
                                <div class='usr-card-content'>
                                    <h3>Jessica Dolof</h3>
                        ...
                        data-content="
                        <div class='usr-card'>
                            <img src='/theme/img/avatars/3.png' alt='Zekarburg Almandalie'>
                            <div class='usr-card-content'>
                    ...
                    data-content="
                    <div class='usr-card'>
                        <img src='/theme/img/avatars/4.png' alt='Barley Krazurkth'>
                        <div class='usr-card-content'>
                ...
                data-content="
                <div class='usr-card'>
                    <img src='/theme/img/avatars/female.png' alt='Farhana Amrin'>
                    <div class='usr-card-content'>
                        <h3>Farhana Amrin</h3>
            ...
            data-content="
            <div class='usr-card'>
                <img src='/theme/img/avatars/male.png' alt='Lezley Jacob'>
                <div class='usr-card-content'>
                    <h3>Lezley Jacob</h3>
                    <p>Sales Director</p>
                </div>
                                ...
                                <div class="widget-body widget-hide-overflow no-padding">
                                    ...
                                    <div id="chat-container">
                                        ...
                                        <div class="chat-list-body custom-scroll">
                                            <ul id="chat-users">
                                                <li>
                                                    <a href="javascript:void(0);"><img src="/theme/img/avatars/5.png" alt="">Robin Berry <span class="badge badge-inverse">23</span><span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0);"><img src="/theme/img/avatars/male.png" alt="">Mark Zeukartech <span class="state"><i class="last-online pull-right">2hrs</i></span></a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0);"><img src="/theme/img/avatars/male.png" alt="">Belmain Dolson <span class="state"><i class="last-online pull-right">45m</i></span></a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0);"><img src="/theme/img/avatars/male.png" alt="">Galvitch Drewbery <span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0);"><img src="/theme/img/avatars/male.png" alt="">Sadi Orlaf <span class="state"><i class="fa fa-circle txt-color-green pull-right"></i></span></a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0);"><img src="/theme/img/avatars/male.png" alt="">Markus <span class="state"><i class="last-online pull-right">2m</i></span> </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0);"><img src="/theme/img/avatars/sunny.png" alt="">Sunny <span class="state"><i class="last-online pull-right">2m</i></span> </a>
                                                </li>
                                                <li>
                                                    <a href="javascript:void(0);"><img src="/theme/img/avatars/male.png" alt="">Denmark <span class="state"><i class="last-online pull-right">2m</i></span> </a>
                                                </li>
                                            </ul>
                                        </div>
                                    ...
                                    <div id="chat-body" class="chat-body custom-scroll">
                                        <ul>
                                            <li class="message">
                                                <img src="/theme/img/avatars/5.png" class="online" alt="">
                                                ...
                                                <li class="message">
                                                    <img src="/theme/img/avatars/sunny.png" class="online" alt="">
                                                    <div class="message-text">
                                                        <time>
                                                            2014-01-13
