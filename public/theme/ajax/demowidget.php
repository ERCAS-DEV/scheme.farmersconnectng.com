...
<div id="flotcontainer" style="height:200px; width:100%;"></div>
	...
	<script type="text/javascript">
		...
		*/
		...
		loadScript("/theme/js/plugin/flot/jquery.flot.cust.min.js", loadFlotResize);
	
		function loadFlotResize() {
			loadScript("/theme/js/plugin/flot/jquery.flot.resize.min.js", loadFlotToolTip);
		}
	
		function loadFlotToolTip() {
			loadScript("/theme/js/plugin/flot/jquery.flot.tooltip.min.js", generateRandomFlot);
		}
